    ...
    children: [
      {
        title: '生活垃圾',
        ...commonConfig,
        customForm: { originType: '固废处置', secondType: '生活垃圾' }
      },
      {
        title: '工程渣土',
        ...commonConfig,
        customForm: { originType: '固废处置', secondType: '工程渣土' }
      }
    ]
  },
  {
    ...
    children: [
      {
        title: '管道然气设施',
        ...commonConfig,
        customForm: { originType: '城镇燃气', secondType: '管道然气设施' }
      },
      {
        title: '瓶装燃气设施',
        ...commonConfig,
        customForm: { originType: '城镇燃气', secondType: '瓶装燃气设施' }
      },
      {
        title: '燃气餐饮用户',
        ...commonConfig,
        customForm: { originType: '城镇燃气', secondType: '燃气餐饮用户' }
      },
      {
        title: '燃气企业',
        ...commonConfig,
        customForm: { originType: '城镇燃气', secondType: '燃气企业' }
      }
    ]
  },
  {
