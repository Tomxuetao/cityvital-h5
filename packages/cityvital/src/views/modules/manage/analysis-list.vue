...
import AnalysisCard from './comp/analysis-card.vue'
      ...
      <div class="ctx-inner">
        <div class="inner-title">
          <common-title text="研判结果列表">
            <common-sheet v-model="searchForm.event_status" :list="mapToList(manageEventStatusMap)" :trigger-type="1" label="全部"></common-sheet>
          </common-title>
        </div>
...
.analysis-wrap {
  .analysis-header {
    ...
    background-image: url("../sign/img/img-sign-bg.webp");
